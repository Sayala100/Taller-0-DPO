...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pais del atleta");
	...
	private void ejecutarNombrePais()
	{
		System.out.println("\n" + "Pais del que proviene el atleta" + "\n");
		
		String arch = input("Por favor ingrese el nombre del atleta");
		
		
		{

			Pais atletas = calculadora.atletasPais(arch);
			if (atletas == null)
			{
