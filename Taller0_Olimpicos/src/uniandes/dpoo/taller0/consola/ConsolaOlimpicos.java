...
public class ConsolaOlimpicos
{
	...
	private void ejecutarbuscarAtletaPais() {
	
	
		System.out.println("\n" + "Pais del Atleta" + "\n");

		String elAtleta = input("Por favor ingrese el nombre de un atela");
		Atleta PaisAt = calculadora.buscarAtleta(elAtleta);
		Pais LugarAr = PaisAt.darPais();
		String NombrePais = LugarAr.darNombre();
		System.out.println("El pais del atleta es: " + NombrePais);
	}	
	/**
